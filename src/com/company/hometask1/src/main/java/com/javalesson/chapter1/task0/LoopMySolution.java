...
public class LoopMySolution {

    public static void main(String[] args) {
        System.out.println("Введите количество циклов выполнения программы");
        ...
        for (int i = 0; i < num; i++) {
            ...
            int z = in.nextInt();
            countExpression(num, x, y, z);
        }
        in.close();
    }

    public static void countExpression(int m, int a, int b, int n) {
        int res = a;
        for (int i = 0; i < n; i++) {
